...
%¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­
    [Da]= WLCHS(Input,Output,D,unknown_w2,Lw,0.0005,lamada);
    MSDg = MSDg + Da.MSE;  
    [Da]= WL_NCCHSAF(Input,Output,noise,D,unknown_w2,Lw,lamada,0.5,0.0005,-10);
    MSDb = MSDb + Da.MSE;
end
%¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­
%¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­
...
h=legend('WL-CHSAF \mu=0.0005','WL-NCCHSAF \mu=0.0005 ' );
%     ,'WL-CHSAF \mu=0.5','WL-NCCHSAF \mu=0.5');
