...
%¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­
    [Da]= LNCCHS(Input,Output,noise,D,unknown_w2,Lw,0.6,0.5,0.005,-5);
    MSDg = MSDg + Da.MSE;  
    [Da]= NCCHS2(Input,Output,noise,D,unknown_w2,Lw,0.6,0.5,0.005,-5);
    MSDb = MSDb + Da.MSE;
    [Da]= LNCCHS(Input,Output,noise,D,unknown_w2,Lw,0.6,0.5,0.05,-5);
    MSDr = MSDr + Da.MSE;
    [Da]= NCCHS2(Input,Output,noise,D,unknown_w2,Lw,0.6,0.5,0.05,-5);
    MSDk = MSDk + Da.MSE;
end
%¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­
%¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­¡­
...
h=legend('WL-NCAFHS \mu=0.03','NCAFHS \mu=0.03 ','WL-NCAFHS \mu=0.05','NCAFHS \mu=0.05');
